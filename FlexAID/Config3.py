...
class Config3:
    ...
    def Frame(self):
        ...
        fHETLine1.pack(fill=X)
        fHETLine2 = Frame(fHET)
        fHETLine2.pack(fill=X)
        fHETLine3 = Frame(fHET)
        fHETLine3.pack(fill=X)
        ...
        fPermeaLine1.pack(fill=X)
        fPermeaLine2 = Frame(fPermea)
        fPermeaLine2.pack(fill=X)
        ...
        fDeltaLine1.pack(fill=X, side=TOP)
        fDeltaLine2 = Frame(fDelta)
        fDeltaLine2.pack(fill=X, side=TOP)
        fDeltaLine3 = Frame(fDelta)
        fDeltaLine3.pack(fill=X, side=TOP)
        fDeltaLine4 = Frame(fDelta)
        fDeltaLine4.pack(fill=X, side=TOP)
        ...
        fDEELine1.pack(fill=X, side=TOP, pady=10)
        fDEELine2 = Frame(fDelta)
        fDEELine2.pack(fill=X, side=TOP)
        fDEELine3 = Frame(fDelta)
        fDEELine3.pack(fill=X, side=TOP)
        fDEELine4 = Frame(fDelta)
        fDEELine4.pack(fill=X, side=TOP)
        ...
        fSolventLine1.pack(fill=X, side=TOP)
        fSolventLine2 = Frame(fSolvent)
        fSolventLine2.pack(fill=X, side=TOP)
        fSolventLine3 = Frame(fSolvent)
        fSolventLine3.pack(fill=X, side=TOP)
